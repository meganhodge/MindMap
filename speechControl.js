...
var CMD_BUBBLE_DELETE = "Delete bubble";
var CMD_BUBBLE_CREATE = "Create bubble";
var CMD_BUBBLE_LINK = "Link bubble";
var CMD_BUBBLE_COLOR = "Bubble color";

var CMD_TEXT_ENTRY = "Enter text";
...
function handleCommandRecognized(command) {
    ...
    else if (command == CMD_BUBBLE_CREATE){
      addBubble();
    }
    else if (command == CMD_BUBBLE_DELETE){
      deleteBubble(entityID);
    }
    else if (command == CMD_TEXT_ENTRY){
      addText();
    }
}
...
function deleteBubble(entityID) {
